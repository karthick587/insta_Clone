        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                <div class="flex flex-col items-center my-6 uk-visible@s">
                    ...
                    <a href="profile.html" class="text-xl font-medium capitalize mt-4 uk-link-reset">{UserDetails?.UserName}
                    </a>
                ...
                <ul>
                    <li >
                        <Link to="/UserProfile" className={pathName === "/UserProfile" ? "Active" : ""} >
                            <i class="uil-store"></i>
                            <span> Profile </span>
                        </Link>
                    </li>
                    <li >
                        <Link to="/feeds" className={pathName === "/feeds" ? "Active" : ""} >
                    ...
                    <li>
                        <Link className={pathName === "/messanger" ? "Active" : ""} to="/messanger" >
                ...
                <li>
                    <Link className={pathName === "/PeopleList" ? "Active" : ""} to="/PeopleList" >
                        <i class="uil-store"></i>
                        <span> Peoples </span>
                    </Link>
                </li>
